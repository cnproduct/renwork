        ...
        await ctx.prove("The local claim success page is centered and makes copying the sign-in code the clear next step", {
          ...
          assert: async () => {
            const state = await ctx.eval(`(() => {
              ...
              const open = [...document.querySelectorAll('button')].find((button) => button.textContent?.includes('Open RenWork'));
          ...
          screenshot: {
            ...
            requireText: ["DEMO WORKSPACE READY", "Copy sign-in code", "Open RenWork", "Continue in browser instead"],
