      ...
      run: async (ctx) => {
        await ctx.prove("With the org capability off and zero usable connections, Connect shows the pitch state", {
          ...
          action: async () => {
            ...
            await ctx.waitForText("Connect is the new way RenWork lets you share workflows with your team.", { timeoutMs: 30_000 });
          },
          assert: async () => {
          ...
          screenshot: {
            ...
            requireText: ["Connect is the new way RenWork lets you share workflows with your team.", "Manage in Den web"],
