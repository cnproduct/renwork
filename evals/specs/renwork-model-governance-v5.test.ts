...
test("V5 separates platform provider administration from organization model policy", async ({ evidence }) => {
  ...
  evidence.fact("Cloud model selection is read-only", "Members and organization Owners can choose only published and entitled RenWork models; desktop Ollama and BYOK management is disabled for every profile.", true);
