...
const downloadLinks = {
  ...
  platforms: {
    macos: {
      page: "https://app.openworklabs.com?mode=sign-up",
      note: "Sign up for RenWork Cloud first, then use the guided desktop app access flow.",
    },
    windows: {
      page: "https://app.openworklabs.com?mode=sign-up",
      note: "Sign up for RenWork Cloud first, then use the guided desktop app access flow.",
...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Return RenWork's pricing tiers, what each includes, and the CTA destination. Read-only; does not navigate.",
    inputSchema: {
      type: "object",
      properties: {},
      additionalProperties: false,
