...
const TEAM_EMAIL = "support@rrenn.com";
...
export function AppFeedbackForm(props: Props) {
  ...
  const contextItems = useMemo(
    () => [
      ...
      { label: "RenWork server", value: props.prefill.openworkServerVersion },
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[1.5rem] border border-white/70 bg-white/85 p-6 shadow-sm backdrop-blur">
          ...
          <h1 className="max-w-2xl text-3xl font-semibold tracking-tight text-[#011627] md:text-4xl">
            {mode === "contact"
              ? "Have questions about RenWork?"
              : "Tell us what broke, felt rough, or needs polish."}
          </h1>
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-slate-600">
            {mode === "contact"
              ? "Send the RenWork team a note about sales, security, support, or anything else you want to ask."
              : "Your note goes to the RenWork team with your contact details, app version, and runtime context already attached."}
          </p>
