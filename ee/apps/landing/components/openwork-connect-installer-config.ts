...
export const CONNECT_CLIENT_SUPPORT: Record<OpenWorkConnectClientId, OpenWorkConnectClientSupport> = {
  ...
  "codex": {
    status: "Setup only",
    explanation: "Setup guide only: add RenWork, run codex mcp login openwork, and reconnect with logout then login. Native proof must be rerun on this exact branch."
  },
  "chatgpt-desktop": {
    status: "Setup only",
