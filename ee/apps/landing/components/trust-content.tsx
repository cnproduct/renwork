...
export const dataHandlingRows: DataHandlingRow[] = [
  {
    ...
    cloud: "Not stored by RenWork. Accessed at runtime through your LLM provider."
  },
  {
    dataType: "LLM API keys",
    selfHosted: "Local keychain or environment variables",
    cloud: "Held by your LLM provider, not by RenWork"
  },
  {
    dataType: "Prompts & responses",
    selfHosted: "Local only",
    cloud: "Sent to your LLM provider. Not logged by RenWork."
  },
  {
