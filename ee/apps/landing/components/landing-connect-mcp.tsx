    ...
    <section id="connect-mcp" className="landing-shell rounded-[2.5rem] p-8 md:p-12 scroll-mt-24">
      <div className="mb-10">
        ...
        <h2 className="max-w-3xl text-3xl font-medium leading-[1.15] tracking-tight md:text-4xl lg:text-5xl">
          Already doing it in your agent?<br />Add it to RenWork. Share it with everyone.
        </h2>
        <p className="mt-5 max-w-3xl text-[16px] leading-7 text-gray-600 md:text-lg md:leading-8">
          ...
          and your whole team runs them in RenWork — or from their own agent.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch">
        ...
        >
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 font-mono text-[12px] leading-6 text-gray-100 md:p-5">
            <div>
              <span className="text-cyan-300">❯</span> share my skills and MCPs with my RenWork org
            </div>
        ...
        >
          <div className="flex items-center justify-between gap-3 border-b border-gray-100 bg-gray-50/80 px-4 py-2.5">
            <div className="flex items-center gap-3">
              ...
              <div className="text-[12px] font-medium text-gray-500">RenWork</div>
            </div>
      ...
      >
        ...
        <div className="min-w-0">
          <div
            role="tablist"
            aria-label="RenWork MCP client install options"
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <p className="text-[12px] leading-5 text-gray-500">
                          Works with your RenWork account —{" "}
                          <a
                            href={SIGNUP_URL}
                            target="_blank"
                            rel="noreferrer"
                        ...
                        <button
                          type="button"
                          aria-label="Copy the RenWork MCP install command"
                          onClick={() => {
        ...
        <div className="mt-5 flex flex-col gap-2 border-t border-gray-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
            ...
            <button
              type="button"
              aria-label="Copy the RenWork MCP server URL"
              onClick={() => {
                void copyServerUrl();
              }}
      ...
      <div className="mt-8 flex flex-col gap-3 border-t border-gray-100 pt-5 text-[13px] leading-6 text-gray-600 sm:flex-row sm:items-center sm:justify-between">
        <p>
          ...
          support — your agent signs in with your RenWork account, and access is scoped by org membership, roles, policies, and exposure allowlists.
        </p>
        <a
          href={DOCS_URL}
          target="_blank"
