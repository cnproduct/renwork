...
export const metadata = {
  ...
  description:
    "See what RenWork supports today and what is coming next for the desktop app, RenWork Connect, hosted workspaces, Slack, mobile, and reliable agent workflows.",
  alternates: {
    canonical: "/roadmap"
  },
  openGraph: {
