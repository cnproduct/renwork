      ...
      "service-desc": [
        {
          ...
          title: "RenWork Den API — OpenAPI 3.1 document",
        },
      ],
      "service-doc": [
        {
          ...
          type: "text/html",
          title: "RenWork Den API — human documentation",
        },
      ],
      status: [
        {
          ...
          title: "RenWork Den API — health endpoint",
        },
      ],
      "service-meta": [
        {
          ...
          type: "text/plain",
          title: "RenWork llms.txt — agent-facing site guide",
        },
      ],
    },
  ],
