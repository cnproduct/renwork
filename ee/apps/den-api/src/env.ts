...
const EnvSchema = z.object({
  ...
  RENWORK_METASO_H3_LICENSE_EVIDENCE_ID: z.string().optional(),
  RENWORK_METASO_H3_API_KEY: z.string().optional(),
  RENWORK_METASO_H3_BASE_URL: z.string().optional(),
  RENWORK_METASO_H3_RESULT_HOSTS: z.string().optional(),
  RENWORK_H3_RENCREDIT_MICROCREDITS_PER_SECOND: z.string().optional(),
  RENWORK_H3_PRICE_VERSION: z.string().optional(),
  RENWORK_H3_LIVE_CANARY: z.string().optional(),
  RENWORK_H3_CANARY_ORGANIZATION_ID: z.string().optional(),
