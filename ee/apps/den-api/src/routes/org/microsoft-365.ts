...
const CONNECT_MICROSOFT_ACCOUNT_MESSAGE = "Connect your Microsoft work account first: open Settings > Connect and use Connect your account on the Microsoft 365 row, or connect from the RenWork Cloud dashboard."
...
function missingPermissionMessage(label: string): string {
  return `Your connected Microsoft account is missing the ${label} permission. An admin can enable it on the Microsoft 365 connector in RenWork Cloud -> Connectors; then reconnect your account.`
}
