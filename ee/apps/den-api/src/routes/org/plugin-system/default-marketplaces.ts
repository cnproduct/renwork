...
export const DEFAULT_OPENWORK_MARKETPLACE_NAME = "RenWork Marketplace"
export const DEFAULT_OPENWORK_MARKETPLACE_DESCRIPTION = "Built-in RenWork AI capabilities available in the desktop app after sign-in."
