...
import { registerOrgModelPolicyRoutes } from "./model-policy.js"
...
import { registerOrgVideoGenerationRoutes } from "./video-generation.js"
...
export function registerOrgRoutes<T extends { Variables: OrgRouteVariables & RequestIdVariables }>(app: Hono<T>) {
  ...
  registerOrgModelPolicyRoutes(app)
  ...
  registerOrgVideoGenerationRoutes(app)
