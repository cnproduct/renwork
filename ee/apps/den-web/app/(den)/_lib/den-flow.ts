...
export class DenRequestTimeoutError extends Error {
  ...
  constructor(timeoutMs: number, cause?: unknown) {
    super(
      `RenWork stopped waiting after ${formatDeadlineDuration(timeoutMs)}. The operation’s outcome is unknown.`,
...
export class DenRequestCanceledError extends Error {
  ...
  constructor(cause?: unknown) {
    super(
      "The RenWork request was canceled before the dashboard received a result. The operation’s outcome is unknown.",
      cause === undefined ? undefined : { cause },
    );
...
export const DEFAULT_AUTH_NAME = "RenWork User";
