  ...
  return (
    <div className="mx-auto max-w-[1100px] px-4 pb-8 pt-4 sm:px-6 md:px-8">
      ...
      <div className="flex flex-wrap items-center gap-2.5 border-b border-[#e7e9f0] pb-3">
        <span className="text-[14px] font-semibold tracking-[-0.01em] text-[#07192C]">{activeOrg?.name ?? "RenWork Cloud"}</span>
      ...
      <p className="mt-1 text-[14px] leading-6 text-[#5A6886]">
        Work securely on this device and move to shared workflows when ready.
      </p>
      ...
      <div className="mt-5 grid gap-3.5 md:grid-cols-2">
        <StatCard icon={<Users className="h-5 w-5 text-[#6F3DFF]" />} title="RenWork users" value={`${members}`} sub="Current workspace members" tone="violet" />
