...
export const INTEGRATION_PROVIDERS: Record<IntegrationProvider, IntegrationProviderMeta> = {
  github: {
    provider: "github",
    name: "GitHub",
    description: "Install the RenWork GitHub App, then pick a repository to turn into a connector instance.",
  ...
  const base: IntegrationRepo[] = [
    {
      ...
      description: "Core RenWork monorepo — desktop, server, and cloud apps.",
      hasPlugins: true,
    },
    {
