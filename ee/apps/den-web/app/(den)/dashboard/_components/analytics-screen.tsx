  ...
  return (
    <div className="mx-auto max-w-[1100px] px-4 pb-8 pt-4 sm:px-6 md:px-8">
      ...
      <p className="mt-1 text-[14px] leading-6 text-[#5A6886]">
        See how your team is adopting RenWork — active members, sessions, and task activity over time.
      ...
      <p className="mt-5 text-[12px] leading-5 text-[#9AA5BA]">
        ...
        Usage data appears here once members sign in to the RenWork app and start running tasks.
      </p>
      </>
      )}
    </div>
