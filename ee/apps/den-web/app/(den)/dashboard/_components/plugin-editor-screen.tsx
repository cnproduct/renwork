      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-[15px] text-gray-500">
            Bundle skills, commands, and MCP servers your team can install in RenWork with one click.
          </p>
        </div>
        <Link
      ...
      <div className="mt-6 flex flex-col gap-4 rounded-[24px] border border-gray-200 bg-white p-6">
        ...
        <div>
          ...
          <p className="mt-1.5 text-[13px] text-gray-500">
            Publishing puts the plugin in the marketplace so members find it in the RenWork app.
          </p>
        </div>
      </div>
