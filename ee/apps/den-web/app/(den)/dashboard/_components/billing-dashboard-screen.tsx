  ...
  return (
    <div data-testid="stripe-billing-screen">
      <DashboardPageTemplate
        icon={CreditCard}
        title="Billing"
        description="Two separate subscriptions: seats for your team, and access to RenWork's built-in AI models. You can have one without the other."
      ...
      <DenCard data-testid="billing-ai-card">
        <DenSectionHeader
          title="AI model access"
          description="Use RenWork's built-in models with no API keys to manage. Separate from seats."
          action={
            !aiConfigured
              ? <DenBadge tone="neutral">Not billed</DenBadge>
              : aiPaymentFailed
        ...
        <DenActionList className="mt-5">
          {aiActive ? (
            ...
            <DenActionRow
              description={
                aiConfigured
                  ? `Turning this on costs ${aiChargeLabel} per ${stripeBilling.interval} for your ${activeMemberCount} ${activeMemberCount === 1 ? "member" : "members"}, not ${stripePrice}. You subscribe from the RenWork Models page.`
                  : "See which models RenWork ships with and how your team connects their own provider keys."
              }
              action={
