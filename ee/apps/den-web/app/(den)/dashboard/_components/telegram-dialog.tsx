        ...
        {showSetup && !connectionQuery.isLoading ? (
          <div className="mt-5 space-y-4">
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
              ...
              <p className="mt-1 text-[12px] leading-5 text-gray-500">Open {" "}<a href="https://t.me/BotFather" target="_blank" rel="noopener noreferrer" className="font-medium text-gray-900 underline decoration-gray-300 underline-offset-4">@BotFather</a>, run /newbot, and paste the token below. RenWork encrypts it at rest and never shows it again.</p>
            ...
            <div className="rounded-2xl border border-amber-100 bg-amber-50 p-4 text-[12px] leading-5 text-amber-800">
              Self-hosted setup needs a stable public HTTPS RenWork API URL so Telegram can deliver the webhook. This first version accepts private text chats only—no groups, channels, or media.
            </div>
