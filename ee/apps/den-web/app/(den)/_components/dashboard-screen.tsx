              ...
              <div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
                <div className="flex max-w-xl flex-col gap-6">
                  ...
                  <p className="text-[16px] leading-relaxed text-[var(--dls-text-secondary)] md:text-[17px]">
                    {isReady
                      ...
                      : "We are allocating resources and preparing the RenWork connection before unlocking the rest of the controls."}
                  </p>
                ...
                <div className="flex w-full flex-col gap-3 md:w-[200px] md:shrink-0 md:items-end">
                  ...
                  <div className="hidden w-full flex-col items-center md:flex">
                    ...
                    <span className="mt-2 text-[11px] font-medium text-[var(--dls-text-secondary)]">requires the RenWork desktop app</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-semibold tracking-tight text-[var(--dls-text-primary)]">RenWork</span>
              </div>
              <button
                type="button"
