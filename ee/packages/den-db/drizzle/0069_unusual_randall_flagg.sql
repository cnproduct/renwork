...
ALTER TABLE `rencredit_usage_events` MODIFY COLUMN `accuracy` enum('reported','estimated','tokenizer') NOT NULL;--> statement-breakpoint
CREATE INDEX `rencredit_runtime_devices_inference_key` ON `rencredit_runtime_devices` (`inference_key_id`);--> statement-breakpoint
CREATE INDEX `rencredit_runtime_devices_status` ON `rencredit_runtime_devices` (`status`);