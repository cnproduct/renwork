CREATE TABLE IF NOT EXISTS `rencredit_runtime_devices` (
	...
	KEY `rencredit_runtime_devices_inference_key` (`inference_key_id`),
	KEY `rencredit_runtime_devices_status` (`status`)
);
