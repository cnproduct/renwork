  ...
  switch (probe.code) {
    ...
    case "http_error":
      ...
      if (probe.httpStatus === 451) {
        message = "The independent runtime endpoint probe received HTTP 451, which indicates an egress proxy, firewall, or allowlist deny rather than an RenWork Cloud catalog shape problem.";
...
function engineAgentCheck(
  ...
  return diagnosticCheck({
    ...
    message: agent
      ...
      : "The selected engine did not resolve an RenWork agent.",
