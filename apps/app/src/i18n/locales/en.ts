...
export default {
  ...
  "commerce.cta_request_access": "Request offline activation",
  "commerce.cta_contact_sales": "Contact sales for offline contract",
  "commerce.cta_checkout": "Continue in browser",
  "commerce.offline_payment_channel": "Offline payment supported. A platform super-admin verifies the payment and activates the entitlement.",
  "commerce.offline_payment_custom": "Offline contract payment supported. Contract amount, seats, and RenCredit must first be published in the authoritative catalog.",
  "commerce.interval_monthly_hint": "Monthly term, currently activated after offline payment; final entitlement follows the cloud order.",
  "commerce.interval_annual_hint": "Annual term, currently activated after offline payment; final entitlement follows the cloud order.",
