...
export default {
  ...
  "commerce.checkout_title": "Choose a payment method",
  "commerce.checkout_description": "The authoritative RenWork catalog sets the amount. Your plan and RenCredit activate only after a verified provider callback.",
  "commerce.pay_wechat": "WeChat Pay",
  "commerce.pay_alipay": "Alipay",
  "commerce.checkout_cancel": "Cancel",
  "commerce.checkout_creating": "Creating a secure payment order…",
  "commerce.checkout_error": "The payment order could not be created. No charge was made.",
  "commerce.checkout_pending": "Order {id} is waiting for payment confirmation.",
  "commerce.checkout_wechat_scan": "Scan with WeChat to pay. RenCredit is granted only after the verified payment callback.",
  "commerce.checkout_fulfilled": "Payment confirmed. Your plan and RenCredit are active.",
