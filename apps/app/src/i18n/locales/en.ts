 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, RenWork) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "RenWork server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "RenWork server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "blueprint.welcome_message": "Hello! I am your RenWork AI Digital Employee 🤖\n\nI can help you with:\n1. 🔍 **OKKI & Customs Buyer Prospecting**: Extract buyer records and verified contacts\n2. 🌐 **6-Language Social Media Automation**: Generate and publish to LinkedIn / Facebook\n3. ✉️ **Personalized Cold Outreach**: Automated email campaigns via Zoho/SMTP\n4. 📊 **B2B Trade Data Processing**: Clean and analyze large CSV/Excel trade datasets\n\nType your task below or choose a skill to get started!",
  "blueprint.welcome_title": "Welcome to RenWork",
  "common.add": "Add",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with renwork-cloud_search_capabilities, then call renwork-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "connect.connected_to_cloud": "Connected to RenWork Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed RenWork agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved RenWork agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "RenWork agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective RenWork agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "RenWork Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "RenWork Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global RenWork Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and RenWork-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single RenWork Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_renwork_client": "RenWork client",
  "connect.diagnostics_owner_renwork_server": "RenWork server",
  "connect.diagnostics_owner_renwork_support": "RenWork support",
  ...
  "connect.diagnostics_configured_agent": "Configured RenWork agent",
  "connect.diagnostics_effective_agent": "Effective RenWork agent",
  "connect.diagnostics_agent_state": "RenWork agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote RenWork workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace RenWork Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from RenWork Den.",
  ...
  "connect.pitch_title": "Connect is the new way RenWork lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to RenWork Cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart RenWork. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected RenWork servers.",
  ...
  "config.server_needed_hint": "RenWork server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an RenWork server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "RenWork server",
  ...
  "config.server_sharing_title": "RenWork server sharing",
  "config.server_url_hint": "Use the URL shared by your RenWork server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "RenWork server URL",
  "config.server_url_label": "RenWork Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable RenWork server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "RenWork server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "RenWork server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "RenWork server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable RenWork server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted RenWork worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted RenWork worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an RenWork server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the RenWork server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted RenWork worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update RenWork and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and RenWork will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs RenWork server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access RenWork Cloud.",
  "den.cloud_section_title": "RenWork Cloud",
  "den.cloud_sleep_hint": "Sign in to RenWork Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use RenWork Cloud.",
  "den.open_dashboard": "Open RenWork admin dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "RenWork Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but RenWork Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid RenWork sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete RenWork Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of RenWork Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an renwork://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into RenWork automatically, paste the sign-in link or one-time code from RenWork Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "renwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to RenWork Cloud",
  "den.signing_in": "Finishing RenWork Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect RenWork.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the RenWork link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect RenWork.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the RenWork link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected RenWork Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected RenWork Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your RenWork Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. RenWork is using the default Cloud control plane.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the RenWork Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to RenWork Cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse RenWork built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through RenWork Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "RenWork Cloud",
  ...
  "mcp.toggle_requires_server": "Connect to an RenWork server to enable or disable MCPs.",
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in RenWork Connect.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so RenWork can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, RenWork needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, RenWork needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize RenWork",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from RenWork.",
  ...
  "mcp.name_reserved_renwork_connect": "This name is reserved for RenWork Connect. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from RenWork Connect and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "RenWork encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_renwork_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_renwork_cloud_title": "RenWork Cloud Control",
  "mcp.quick_connect_renwork_ui_desc": "Let agents see and drive the RenWork app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_renwork_ui_title": "RenWork UI Control",
  ...
  "notifications.empty_hint": "Updates from RenWork Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the RenWork server",
  ...
  "welcome.title": "Welcome to RenWork",
  "welcome.subtitle": "人人易AI · Your AI Digital Employee for Global Trade Growth",
  "welcome.creating_workspace": "Initializing digital employee workspace\u2026",
  "welcome.get_started": "🚀 Launch Digital Employee Workspace",
  "welcome.sign_in_cloud": "Sign in to RenWork Cloud Hub",
  "welcome.use_without_cloud": "🚀 Launch Digital Employee Workspace",
  "welcome.join_org": "Connect to Organization Hub",
  "welcome.join_org_subtitle": "Paste your team invitation link or server URL",
  "welcome.local_only": "Continue with Local Digital Employee",
  "welcome.organization_server_change": "Change",
  "welcome.organization_server_connected": "Connected to {host}",
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. RenWork will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// RenWork server URL.",
  "welcome.organization_server_link": "Using RenWork on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://renwork.yourcompany.com",
  "welcome.team_signin": "Joining a team? Sign in",
  "welcome.use_cloud": "Use RenWork Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted RenWork and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. RenWork will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and RenWork can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. RenWork will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an RenWork invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid RenWork organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "RenWork could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, server URLs, “server token”, renwork://den-auth links, or a raw sign-in code.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. RenWork now points at {host} and is ready when you come back.",
  "join_org.renwork_cloud": "RenWork Cloud",
  ...
  "session.share_local_host_not_ready": "Local RenWork host is not ready yet.",
  "session.share_missing_host_url": "Missing RenWork host URL.",
  "session.share_missing_token": "Missing RenWork token.",
  ...
  "session.share_renwork_workers_only": "Share service links are available for RenWork workers.",
  ...
  "settings.privacy_section_desc": "Control what RenWork shares to improve the product.",
  ...
  "settings.capabilities_title": "RenWork server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point RenWork at a local OpenCode build",
  ...
  "settings.debug_renwork_server_version": "RenWork server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "RenWork writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No RenWork-managed keys removed.",
  "settings.runtime_config_backup_path": "Backup: {path}",
  "settings.runtime_config_no_backup": "No backup needed.",
  "settings.error": "Error",
  "settings.idle": "Idle",
  "settings.loading": "Loading",
  "settings.deeplink_hint": "Accepts renwork:// or renwork-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which RenWork events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by RenWork. Off by default.",
  ...
  "settings.feedback_title": "Help shape RenWork",
  ...
  "settings.nuke_confirmation_hint": "RenWork will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local RenWork, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed RenWork app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's RenWork state (.opencode/renwork) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an RenWork deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard RenWork Cloud.",
  "settings.organization_server_desc": "Point RenWork at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's RenWork server URL. Saving signs you out so RenWork can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by RenWork.",
  ...
  "settings.renwork_config_sidecar_desc": "Local RenWork server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.renwork_diagnostics_title": "RenWork server diagnostics",
  "settings.renwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.renwork_server_label": "RenWork server",
  ...
  "settings.providers_desc": "View RenWork models published by the platform and allowed for the active organization.",
  "settings.providers_title": "RenWork model catalog",
  "settings.renwork_model_billing_info": "Models are configured by the RenWork platform and settled under organization plan and RenCredit rules.",
  "settings.renwork_provider_admin_only": "Members and organization Owners can only use RenWork models published by the platform and allowed by the organization. Providers, API keys, and local models are managed only by platform super admins.",
  "settings.quit_hint": "RenWork quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect RenWork server.",
  "settings.reconnected": "Reconnected to RenWork server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears RenWork cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears RenWork cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. RenWork will restart.",
  ...
  "settings.reset_onboarding_description": "Clears RenWork preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears RenWork local preferences and workspace onboarding markers.",
  "settings.reset_renwork_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside renwork-dev-data.",
  "settings.reset_renwork_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside renwork-dev-data.",
  "settings.reset_renwork_title": "Reset RenWork + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but RenWork will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_renwork_server": "Restart RenWork server",
  ...
  "settings.services_section_desc": "Local services that power this RenWork session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting RenWork.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs RenWork will use after local overrides and bootstrap files are applied.",
  "settings.server_endpoints_local_dev": "Local dev server",
  "settings.server_endpoints_mismatch": "Doesn't match API endpoint",
  "settings.server_endpoints_not_configured": "No renwork-cloud MCP entry configured",
  ...
  "settings.compatibility_details": "Compatibility details",
  "settings.legacy_renwork_metadata": "Legacy RenWork metadata",
  "settings.runtime_migration_desc": "Moves older RenWork-managed runtime settings into the runtime database while preserving existing workspaces and saved tasks.",
  ...
  "settings.runtime_desc": "Status for your local engine and RenWork server.",
  ...
  "settings.tab_ai": "AI Models & Providers",
  ...
  "settings.tab_connect": "RenWork Connect",
  ...
  "settings.tab_description_appearance": "Adjust how RenWork looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected RenWork workspace plus its runtime connection.",
  ...
  "settings.environment.description": "Save API keys and tokens for local agents, skills, and MCP servers. Values are encrypted by the operating-system vault and can only be replaced, never revealed.",
  ...
  "settings.environment.override_hint": "Environment variables set before RenWork starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "RenWork will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "RenWork is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but RenWork status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.replace_value_placeholder": "Enter a replacement value. Saved values cannot be revealed.",
  "settings.environment.secure_value": "Stored securely · never revealable",
  "settings.environment.system_auth_required": "System authentication is required to change protected secrets.",
  "settings.environment.create_vault_password": "Create a RenWork Secret Vault password (at least 10 characters):",
  "settings.environment.confirm_vault_password": "Confirm the RenWork Secret Vault password:",
  "settings.environment.enter_vault_password": "Enter your RenWork Secret Vault password:",
  "settings.environment.password_mismatch": "The two passwords do not match.",
  "settings.environment.admin_only": "Environment secrets are available only to organization administrators on this device.",
  "settings.environment.password_too_short": "The vault password must contain at least 10 characters.",
  "settings.environment.vault_auth_title": "Unlock RenWork Secret Vault",
  "settings.environment.touch_id_hint": "Use Touch ID to authorize this protected change.",
  "settings.environment.vault_password_label": "Vault password",
  "settings.environment.authorize": "Authorize",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by RenWork/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your RenWork account to view your memory bank.",
  ...
  "settings.update_blocked_org": "RenWork {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts RenWork and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts RenWork now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep RenWork up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an RenWork host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected RenWork server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active RenWork Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active RenWork Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "RenWork Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full RenWork features",
  ...
  "status.renwork_ready": "RenWork Ready",
  ...
  "system.reload_body_default": "RenWork detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "RenWork detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "RenWork can't load tasks from this worker until the connection is fixed.",
  ...
  "session_management.move_to_workspace": "Move to workspace",
  "session_management.session_moved": "Session moved successfully",
  "session_management.session_moved_to": "Moved session to workspace \"{workspace}\"",
  "session_management.session_move_failed": "Failed to move session",
  ...
  "settings.tab_commerce": "Plans & RenCredit",
  "settings.tab_description_commerce": "Subscription plans, account entitlements, and RenCredit usage.",
  "commerce.account_center_title": "Account entitlements",
  "commerce.account_center_description": "Subscription and RenCredit are shown separately. RenWork never treats a test balance as a real entitlement.",
  "commerce.subscription_title": "Subscription",
  "commerce.subscription_pilot": "RenWork models require an active subscription or a time-limited platform super-admin grant.",
  ...
  "commerce.credit_available": "Available",
  "commerce.credit_frozen": "Reserved",
  "commerce.credit_durable": "Available and reserved balances come from the durable cloud ledger.",
  "commerce.credit_error": "The durable cloud ledger is temporarily unavailable. Try again shortly.",
  "commerce.activity_title": "RenCredit activity",
  "commerce.activity_description": "Inspect task reservations, settled charges, releases, and immutable account movements.",
  "commerce.activity_loading": "Loading the cloud ledger…",
  "commerce.activity_error": "Some RenCredit records are temporarily unavailable. Try again shortly.",
  "commerce.refresh": "Refresh",
  "commerce.receipts_title": "My task receipts",
  "commerce.receipts_description": "Only tasks started by this account in the active workspace are shown. No result means no charge.",
  "commerce.receipts_empty": "No task receipts yet. A receipt appears after an official priced task runs.",
  "commerce.receipt_status_reserved": "Processing",
  "commerce.receipt_status_captured": "Settled",
  "commerce.receipt_status_released": "Released",
  "commerce.receipt_free": "Free",
  "commerce.receipt_task_id": "Task {id}",
  "commerce.receipt_usage_pending": "Waiting for model usage",
  "commerce.receipt_tokens": "{total} tokens (input {input} / output {output})",
  "commerce.receipt_billed_tokens": "Provider-reported billable token total: {total}",
  "commerce.context_capacity_title": "Task context reference",
  "commerce.context_capacity_value": "{used} / {limit} ({percent}%)",
  "commerce.context_capacity_unknown": "{used} tokens · window unavailable",
  "commerce.context_capacity_note": "Reference only: input + output + reasoning compared with the current model context window. Cache tokens are listed separately.",
  "commerce.settlement_title": "RenCredit settlement",
  "commerce.settlement_reserved": "Reserved",
  "commerce.settlement_captured": "Charged",
  "commerce.settlement_released": "Released",
  "commerce.token_input": "Input {value}",
  "commerce.token_output": "Output {value}",
  "commerce.token_reasoning": "Reasoning {value}",
  "commerce.token_cache_read": "Cache read {value}",
  "commerce.token_cache_write": "Cache write {value}",
  "commerce.receipt_frozen": "Reserved, not charged",
  "commerce.receipt_charged": "Actual charge",
  "commerce.receipt_no_charge": "No result or failed, no charge",
  "commerce.ledger_title": "Organization ledger",
  "commerce.ledger_description": "Administrators only. Every reservation, settlement, and release is immutable.",
  "commerce.ledger_empty": "No ledger entries yet.",
  "commerce.ledger_grant": "RenCredit grant",
  "commerce.ledger_reserve": "Task reservation",
  "commerce.ledger_capture": "Task settlement",
  "commerce.ledger_release": "Balance release",
  "commerce.ledger_refund": "Refund",
  "commerce.ledger_adjustment": "Account adjustment",
  "commerce.ledger_balance_after": "Balance {available} · reserved {frozen}",
  "commerce.subscription_required_notice": "RenWork has no default free plan and does not expose BYOK or local models. Campaign access and exceptions are time-limited platform super-admin grants; official model usage is settled through RenCredit.",
  "commerce.plans_title": "RenWork plans",
  "commerce.catalog_version": "Authoritative cloud catalog: {version}",
  "commerce.catalog_authoritative": "Plan details are loaded from the authoritative cloud catalog.",
  "commerce.audience_label": "Plan audience",
  "commerce.interval_label": "Billing interval",
  "commerce.personal": "Personal",
  "commerce.enterprise": "Enterprise",
  "commerce.monthly": "Monthly",
  "commerce.annual": "Annual",
  "commerce.catalog_loading": "Loading the authoritative plan catalog…",
  "commerce.catalog_error": "The plan catalog is temporarily unavailable. No local fallback price was used.",
  "commerce.retry": "Retry",
  "commerce.price_free": "Free",
  "commerce.price_pilot": "Pilot application",
  "commerce.price_contact": "Contact us",
  "commerce.cta_current": "Current plan",
  "commerce.cta_request_trial": "Request pilot access",
  "commerce.cta_request_access": "Choose this plan",
  "commerce.cta_contact_sales": "Contact sales",
  "commerce.cta_checkout": "Continue in browser",
  "commerce.interval_monthly_hint": "Monthly term; final entitlement follows the cloud order.",
  "commerce.interval_annual_hint": "Annual term; final entitlement follows the cloud order.",
  "commerce.interval_not_applicable": "No recurring charge for this offer.",
  "commerce.annual_monthly_equivalent": "Equivalent to {price}/month, billed annually",
  "commerce.included_credits": "{credits} RenCredit per month",
  "commerce.seat_limit": "Up to {seats} accounts",
  "commerce.quality_model_limit": "Quality models: {calls} calls / {hours} hours",
  "commerce.quality_model_fair_use": "Quality models available under fair-use policy",
  "commerce.enterprise_badge": "Team",
  "commerce.enterprise_admin_notice": "Enterprise admins can inspect seats, shared workspaces, the shared RenCredit pool, member limits, and audit receipts. Members cannot see billing credentials or internal provider costs.",
  "commerce.feature_managed_cloud": "Managed RenWork cloud runtime",
  "commerce.feature_official_plugins": "Official priced capabilities",
  "commerce.feature_buyer_growth": "AI buyer growth workflow",
  "commerce.feature_shared_workspace": "Shared team workspace",
  "commerce.feature_shared_credit_pool": "Shared RenCredit pool",
  "commerce.feature_role_management": "Member and role management",
  "commerce.feature_admin_audit": "Administrator audit receipts",
  "commerce.feature_private_deployment": "Private deployment options",
  "computer_history.tab_label": "Work memory",
  "computer_history.tab_description": "Review and manage local computer-history summaries",
  "computer_history.title": "Work memory",
  "computer_history.local_badge": "Local first",
  "computer_history.description": "After you explicitly allow it, RenWork turns activity from selected apps into searchable text summaries so the agent can understand the work you are moving forward.",
  "computer_history.privacy_title": "Clear, controllable privacy boundaries",
  "computer_history.privacy_description": "History is stored on this device by default. Raw screens are never saved or uploaded automatically. Password fields, private windows, and unselected apps are always excluded.",
  "computer_history.status_off": "Off",
  "computer_history.status_paused": "Paused",
  "computer_history.status_recording": "Recording",
  "computer_history.toggle_label": "Enable work memory",
  "computer_history.pause": "Pause",
  "computer_history.resume": "Resume",
  "computer_history.choose_apps": "Choose apps",
  "computer_history.retention_label": "History retention",
  "computer_history.retention_7": "Keep 7 days",
  "computer_history.retention_30": "Keep 30 days",
  "computer_history.retention_90": "Keep 90 days",
  "computer_history.retention_manual": "Delete manually",
  "computer_history.timeline_title": "Computer history",
  "computer_history.timeline_description": "Only text-level work summaries from allowed apps are shown.",
  "computer_history.clear": "Clear history",
  "computer_history.clear_today": "Clear today",
  "computer_history.clear_7": "Clear the last 7 days",
  "computer_history.clear_30": "Clear the last 30 days",
  "computer_history.clear_all": "Clear all",
  "computer_history.cleared": "History cleared",
  "computer_history.ask": "Ask work memory",
  "computer_history.empty_title": "No work memory yet",
  "computer_history.empty_description": "Choose allowed apps and enable recording before RenWork starts creating local text summaries.",
  "computer_history.empty_waiting": "Recording has started. Summaries appear here after you work in an allowed app.",
  "computer_history.group_today": "Today",
  "computer_history.group_yesterday": "Yesterday",
  "computer_history.group_earlier": "Earlier",
  "computer_history.duration_less_minute": "Less than 1 minute",
  "computer_history.duration_minutes": "{count} minutes",
  "computer_history.text_summary_only": "Text summary only",
  "computer_history.delete_entry": "Delete this work-memory entry",
  "computer_history.billing_note": "Browsing, pausing, deleting, and local retrieval do not use RenCredit. Existing entitlements apply only when you actively use an official cloud model or Plugin.",
  "computer_history.apps_title": "Choose apps RenWork may record",
  "computer_history.apps_description": "RenWork records only apps you explicitly select here. Newly installed apps are not added automatically.",
  "computer_history.apps_empty": "No selectable apps were found. Open the app you need, then try again.",
  "computer_history.apps_save": "Save selection",
  "computer_history.select_first": "Choose at least one allowed app first.",
  "computer_history.ask_confirm_title": "Confirm before sending",
  "computer_history.ask_confirm_description": "Choose which history entries RenWork may reference for this task. Unselected content stays out.",
  "computer_history.ask_cloud_disclosure": "Only selected text summaries are sent. Local models keep them on this computer; cloud models receive the selected summaries through the current model service.",
  "computer_history.ask_confirm_cta": "Confirm and create task",
  "computer_history.ask_select_one": "Select at least one work-memory entry.",
  "computer_history.ask_prompt_intro": "Use only the following RenWork work-memory summaries that I explicitly selected to help me continue my work.",
  "computer_history.ask_prompt_guardrail": "Use only facts stated in these summaries. Do not infer unrecorded contacts, transactions, or customer conclusions.",
  "computer_history.ask_prompt_question": "The question I want to continue with is:",
  "computer_history.ask_session_unavailable": "This workspace is not ready to create a work-memory task.",
  "computer_history.desktop_only": "Work memory is currently available only in the RenWork desktop app.",
  "computer_history.permission_required": "Work memory needs macOS Accessibility access to read the current app and window title. It does not need to save the screen.",
  "computer_history.permission_cta": "Open permission helper",
  "computer_history.error_unreadable": "The work-memory state could not be read.",
  "computer_history.error_load": "Could not load work memory.",
  "computer_history.error_update": "Could not update work-memory settings.",
  "computer_history.error_delete": "Could not delete that work-memory entry.",
  "computer_history.error_clear": "Could not clear work memory.",
} as const;
