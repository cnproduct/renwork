...
export default {
  ...
  "config.server_section_desc": "Connect to a RenWork server. Use the URL plus a collaborator or owner token from your server admin.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save a RenWork server as a workspace.",
  ...
  "mcp.toggle_requires_server": "Connect to a RenWork server to enable or disable MCPs.",
  ...
  "join_org.error_invalid": "That does not look like a RenWork invite link, install link, server URL, or sign-in code.",
  ...
  "settings.open_deeplink_desc": "Paste a RenWork deeplink or share URL to open it.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach a RenWork host, then choose it from the list to import this skill.",
