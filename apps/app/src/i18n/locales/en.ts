...
export default {
  ...
  "commerce.subscription_pilot": "Pilot access — renewal details appear after a real subscription is activated.",
  ...
  "commerce.feature_local_free_core": "Local Agent, Ollama, BYOK, and local knowledge",
