...
export const CLOUD_MCP_SERVER_NAME = "renwork-cloud";
export const LEGACY_CLOUD_MCP_SERVER_NAME = "openwork-cloud";

export function isManagedCloudMcpServerName(name: string): boolean {
  return name === CLOUD_MCP_SERVER_NAME || name === LEGACY_CLOUD_MCP_SERVER_NAME;
}
