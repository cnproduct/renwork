...
The artifact preview keeps **outside-chat Markdown** readable with inline \`surface renderer\`, a fenced code block, and [RenWork](https://openworklabs.com).
  ...
  const seedPdfArtifactControlAction = React.useMemo<OpenworkControlAction | null>(() => {
    ...
    return {
      ...
      execute: async () => {
        ...
        // Minimal single-page PDF that draws "RenWork PDF" — base64 encoded.
        const pdfBase64 =
