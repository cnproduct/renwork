...
Shared UI primitives for RenWork apps.
...
The first shared components live under the `paper` namespace and wrap Paper Design shaders with RenWork-specific defaults and deterministic seed support.
...
routes. Its typed sections are exported as `roadmapSections` so other RenWork
