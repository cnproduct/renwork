...
| --- | --- | --- | --- |
| `app.openworklabs.com` | Required for RenWork Cloud | Hosted Cloud web origin. The desktop uses one base URL and derives Den API/MCP calls through `/api/den/...`. | Cloud sign-in, org settings, marketplace, and remote workspace flows cannot load. |
