...
description: "Understand when RenWork model usage starts and how to control it."
---

RenWork uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
