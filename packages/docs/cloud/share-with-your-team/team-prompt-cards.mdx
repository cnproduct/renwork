...
Organization prompt cards are managed from RenWork Cloud and appear in the desktop composer as task suggestions. Managing desktop policies requires an Enterprise plan; the API returns `402` when the org is not entitled.
