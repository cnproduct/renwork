...
description: "Create a custom provider definition in RenWork Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in RenWork Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
<Frame>
  ![DeepSeek V3.2 via Infron in the RenWork Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron · DeepSeek V3.2 selected in an RenWork session](/images/infron-model-active.png)
</Frame>
