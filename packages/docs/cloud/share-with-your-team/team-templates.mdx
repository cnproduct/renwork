...
description: "Create reusable workspace templates for teams in RenWork Cloud"
---
...
1. Build the workspace locally in the RenWork desktop app.
2. Add the skills, MCP servers, commands, agents, and providers the team should start with.
3. Share the setup to your RenWork Cloud organization.
