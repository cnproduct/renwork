...
description: "Create an org on RenWork Cloud, invite teammates into teams, publish a plugin with a skill to a marketplace, and trigger it from the desktop app"
---
...
1. Created an organization on RenWork Cloud.
...
5. Signed in to the org from the RenWork desktop app and triggered the skill with a plain-language prompt.
...
Head to [app.openworklabs.com](https://app.openworklabs.com). Enter your work email and press **Next** — RenWork routes you to the right sign-in step automatically.

<Frame>
  ![Start using RenWork — email step](/images/cloud-team-quickstart/01-signin-email.png)
</Frame>
...
Right after sign-up, RenWork asks you to **name your team**. This creates your organization — you can rename it later, and no credit card is required.
...
Open **Extensions → Plugins**. You'll see RenWork's built-in plugins; click **Create plugin** to add your own.
...
In the **Share** section, keep *Share with everyone in the organization* checked and pick your **Marketplace** — this is what publishes the plugin so members find it in the RenWork app. Click **Create plugin**.
...
Changing workspace access is sensitive, so RenWork asks you to confirm your password first:
...
Now switch to the [RenWork desktop app](https://openworklabs.com). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
...
RenWork shows what your org gives you access to — including your marketplaces:
