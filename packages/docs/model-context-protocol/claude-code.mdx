---
title: "RenWork MCP for Claude Code"
sidebarTitle: "Claude Code"
description: "Claude Code MCP setup for RenWork Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared MCP connections, skills, and Cloud resources."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Code to use the RenWork capabilities your organization has made
