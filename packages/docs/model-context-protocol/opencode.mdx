---
title: "RenWork MCP for OpenCode"
sidebarTitle: "OpenCode"
description: "OpenCode MCP setup for RenWork Connect, RenWork's hosted MCP server for Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables OpenCode to use the RenWork capabilities your organization has made
...
Stripe, Exa, and Context7, shared skills, and RenWork Cloud resources like
...
<Note>
OpenCode is the verified RenWork Connect client. Native remote MCP OAuth passed
...
- Connect from an SSH host with
  [RenWork MCP on a remote machine](/cloud/run-in-the-cloud/connect-openwork-mcp-remote-machine).
