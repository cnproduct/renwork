---
title: "RenWork MCP for Claude Desktop"
sidebarTitle: "Claude Desktop"
description: "Claude Desktop MCP setup for RenWork Connect, using custom connectors or mcp-remote to reach your org's shared capabilities."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Claude Desktop to use the RenWork capabilities your organization has
...
3. Name it `RenWork` and set the URL to:
...
RenWork accepts. Restart Claude Desktop after editing the config.
