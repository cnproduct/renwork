---
title: "RenWork MCP for Gemini CLI"
sidebarTitle: "Gemini CLI"
description: "Gemini CLI MCP setup for RenWork Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Gemini CLI to use the RenWork capabilities your organization has made
...
1. Add RenWork Connect as a remote HTTP MCP server:
...
3. Authenticate RenWork inside Gemini:
