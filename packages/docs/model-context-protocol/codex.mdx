---
title: "RenWork MCP for Codex"
sidebarTitle: "Codex"
description: "Codex MCP setup for RenWork Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Codex to use the RenWork capabilities your organization has made
