---
title: "RenWork MCP for VS Code"
sidebarTitle: "VS Code"
description: "VS Code MCP setup for RenWork Connect, with OAuth access to your org's Gmail, Calendar, Drive, shared connections, skills, and Cloud resources."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables VS Code to use the RenWork capabilities your organization has made
