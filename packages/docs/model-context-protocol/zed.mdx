---
title: "RenWork MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for RenWork Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the RenWork capabilities your organization has made
