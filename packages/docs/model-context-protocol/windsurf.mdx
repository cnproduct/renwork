---
title: "RenWork MCP for Windsurf"
sidebarTitle: "Windsurf"
description: "Windsurf MCP setup for RenWork Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The RenWork MCP server ([RenWork Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Windsurf to use the RenWork capabilities your organization has made
