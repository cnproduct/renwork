...
<title>RenWork Linux Bootstrap — fraimz</title>
...
</head><body><main><h1>RenWork Linux Bootstrap — fraimz</h1><div class="meta">Result: <code>${allOk ? "passed" : "failed"}</code> · Live Den API: <code>${esc(denBaseUrl)}</code> · Frames: ${frames.length}</div>
