...
export function VerificationEmail({ verificationCode }: VerificationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Your RenWork verification code is {verificationCode}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>RenWork</Text>
          <Heading style={styles.heading}>Verify your email</Heading>
          <Text style={styles.text}>Enter this code to finish signing in to RenWork.</Text>
